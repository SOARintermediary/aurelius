            ...
            <div className="animate-fade-in-right">
              <div className="max-w-xl">
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  Aurelius Realty is a luxury real estate investment advisory and lifestyle consultancy, dedicated to serving ultra-high-net-worth individuals and families. We provide curated deal sourcing, investment structuring, and personalized lifestyle integration.
                </p>
                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  We do not act as brokers. All property transactions are facilitated through trusted, RERA-licensed partners, ensuring full compliance while Aurelius Realty maintains exclusive client relationships and bespoke advisory services.
                </p>
